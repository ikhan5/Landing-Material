...
<body onload="init();">
  ...
  <header id="header">
    <nav id="top-nav" class="nav-wrapper">
      <a href="#" class="brand-logo">
        <img height="60" id="logo" src="images/Landing-Images/Logo.svg" alt="Logo for Imzan Khan's Portfolio" />
      </a>
  ...
  <section id="bio" class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col s12 m4 center">
        <img class="bio-image" src="images/Landing-Images/Bio.svg" alt="" />
      </div>
    </div>
  </section>
  <section id="skills" class="container-fluid">
    ...
    <div class="about__skills row">
      <div class="about__skill col s12 m4 center">
        <i class="skill-img fas fa-palette large material-icons grey darken-3"></i>
      ...
      <div class="about__skill col s12 m4 center">
        <i class="skill-img fas fa-database large material-icons grey darken-2"></i>
      ...
      <div class="about__skill col s12 m4 center">
        <i class="skill-img far fa-window-maximize large material-icons grey darken-1"></i>
  ...
  <section id="work" class="container-fluid">
    ...
    <div class="work__projects row">
      <div class="work__example col m4 s12">
        <div class="card hoverable">
          <img class="card-image" src="images/Gifs/Sorting/sorting.gif" title="this slowpoke moves" />
          <div class="work__example_body card-content">
            <h3 class="work__example_name card-title center">Sorting Game</h3>
            ...
            <div class="center card-action row">
              <a href="http://sorting.imzankhan.ca/" target="_blank" class="btn deep-orange accent-4">View Project</a>
              <a href="https://github.com/ikhan5/SortingGame" target="_blank" class="btn orange">View Code</a>
            </div>
          </div>
        </div>
      </div>
      <div class="work__example col m4 s12">
        <div class="card hoverable">
          <img class="card-image" src="images/Gifs/Sorting/blackjack.gif" title="this slowpoke moves" />
          <div class="work__example_body card-content">
            <h3 class="work__example_name card-title center">Black Jack</h3>
            <p class="work_example_description card-text">
            ...
            <div class="center card-action row">
              ...
              <a href="https://github.com/ikhan5/BlackJack" target="_blank" class="btn orange">View Code</a>
            </div>
          </div>
        </div>
      </div>
      <div class="work__example col m4 s12">
        <div class="card hoverable">
          <img class="card-image" src="images/Gifs/Sorting/playlists.gif" title="this slowpoke moves" />
          <div class="work__example_body card-content">
            <h3 class="work__example_name card-title center">
              Create a Playlist
            </h3>
            <p class="work_example_description card-text">
            ...
            <h3 class="languages">Used in the project:</h3>
            <p>HTML5, CSS3, JavaScript, AJAX, jQuery, Bootstrap, PHP and MySQL</p>
            <div class="center card-action row">
              <a href="http://playlists.imzankhan.ca/playlists/index.php?eid=1" target="_blank" class="btn deep-orange accent-4">View Project</a>
              <a href="https://github.com/ikhan5/get-together/tree/master/playlists" target="_blank" class="btn orange">View Code</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="contact" class="container">
    ...
    <form id="contact__form" method="POST" class="col s12">
      ...
      <div class="contact__info clearfix">
        ...
        <button id="contact__submit" class="btn waves-effect waves-light right" type="submit" name="action">
          Submit
    ...
    <div class="container">
      ...
      <div class="col l4 s12 right">
        ...
        <ul>
          ...
          <li><a class="grey-text text-lighten-3" href="#work">Work</a></li>
          <li>
